...
namespace com.zameen.Migrations
{
    ...
    [Migration("20260607042320_AddPropertyPurposeAndTypeInSearchLog")]
    partial class AddPropertyPurposeAndTypeInSearchLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("com.zameen.Models.Agent", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_Agent_UserId");

                    b.ToTable("Agents");
                });

            modelBuilder.Entity("com.zameen.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("com.zameen.Models.Enquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("com.zameen.Models.PriceTrend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("com.zameen.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("com.zameen.Models.Enquiry", b =>
                {
                    b.HasOne("com.zameen.Models.Property", "Property")
                        .WithMany()
