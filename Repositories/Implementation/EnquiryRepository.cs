...
// Repositories/Implementation/EnquiryRepository.cs
public class EnquiryRepository(ApplicationDbContext context) : GenericRepository<Enquiry, int>(context), IEnquiryRepository
{
